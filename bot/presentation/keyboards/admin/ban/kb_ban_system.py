...
kb_ban_menu = InlineKeyboardMarkup(
    inline_keyboard=[
...
kb_ban_system_back = InlineKeyboardMarkup(
    inline_keyboard=[[InlineKeyboardButton(text=L.BACK(), callback_data=BanSystemBack().pack())]]
)
