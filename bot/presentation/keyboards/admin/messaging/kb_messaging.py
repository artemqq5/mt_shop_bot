...
from bot.data.default_constants import ALL_CLIENT_MESSAGING, INDIVIDUAL_MESSAGING
...
kb_messaging_categories = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            InlineKeyboardButton(
                text=L.ADMIN.MESSAGE_ALL_CLIENTS(), callback_data=ChoiceTypeMessaging(type=ALL_CLIENT_MESSAGING).pack()
            )
        ],
        [
            InlineKeyboardButton(
                text=L.ADMIN.MESSAGE_INDIVIDUAL(), callback_data=ChoiceTypeMessaging(type=INDIVIDUAL_MESSAGING).pack()
            )
        ],
    ]
)
...
kb_back_messaging = InlineKeyboardMarkup(
    inline_keyboard=[[InlineKeyboardButton(text=L.BACK(), callback_data=BackMessaging().pack())]]
)
...
kb_skip_messaging_media = InlineKeyboardMarkup(
    inline_keyboard=[
...
kb_skip_messaging_button = InlineKeyboardMarkup(
    inline_keyboard=[
...
kb_repeat_button_messaging = InlineKeyboardMarkup(
    inline_keyboard=[
...
kb_send_message_all_clients = InlineKeyboardMarkup(
    inline_keyboard=[
