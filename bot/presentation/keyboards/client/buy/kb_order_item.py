...
from bot.presentation.keyboards.client.buy.kb_buy_item import BuyChoiceItemBack

kb_buy_item_back = InlineKeyboardMarkup(
    inline_keyboard=[[InlineKeyboardButton(text=L.BACK(), callback_data=BuyChoiceItemBack().pack())]]
)
...
kb_buy_item_skip = InlineKeyboardMarkup(
    inline_keyboard=[
        ...
        inline_keyboard=[
            ...
            [
                InlineKeyboardButton(
                    text=L.CLIENT.BUY.RESTART(), callback_data=BuyOrderItemRestart(item_id=item_id).pack()
                )
            ],
            [InlineKeyboardButton(text=L.BACK(), callback_data=BuyChoiceItemBack().pack())],
        ]
