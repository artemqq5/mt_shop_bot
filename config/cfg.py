...
if is_debug:
    ...
    TRELLO_BASE_URL = TRELLO_BASE_URL_TEST
    CHANNEL_ID = CHANNEL_ID_TEST
    CHANNEL_URL = CHANNEL_URL_TEST
else:
    ...
    TRELLO_BASE_URL = TRELLO_BASE_URL_PROD
    CHANNEL_ID = CHANNEL_ID_PROD
    CHANNEL_URL = CHANNEL_URL_PROD
